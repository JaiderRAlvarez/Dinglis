    ...
    <nav id="nav">
        ...
        <div id="nav-paginas">
            <ul id="nav-lista">
                ...
                <li style="margin-top: 10;"><a style="margin-right: 40px;" class="actual" href="tips.php">Tips</a></li>
                <li><a class="hover-underline-animation" style="margin-right: 40px;" href="inicio.php">Inicio</a></li>
