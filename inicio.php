            ...
            <section style="height: 77%;">
                ...
                <div class="bloque">
                    <p id="parrafo">
                        ...
                        Puedes aprender jugando el videojuego.<br>
                        Si te gusta nuestro proyecto, calificanos.
                    </p>
                </div>
                <div class="bloque">
                    <button class="boton" style="margin-left:20%; margin-top: 30px;"><a href="jugar.php" style="text-decoration: none; color: white;">Jugar</a></button>
